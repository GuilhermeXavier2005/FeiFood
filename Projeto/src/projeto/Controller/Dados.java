...
public class Dados {
    ...
    public void processaDados(String nome, String CPF, String contato){
        try{
    ...
    public void exibir(){
        for(int contador=0;contador<dados.size();contador++){
            System.out.println("-----------------------");
            System.out.println(dados.get(contador).nome);
            System.out.println(dados.get(contador).contato);
            System.out.println(dados.get(contador).CPF);
        }
    }
